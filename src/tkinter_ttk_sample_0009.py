...
def on_mic_button_click() -> None:
    messagebox.showinfo("Mic", "音声入力は未実装です。")
...
def main() -> None:
    ...
    root.title("tkinter / ttk Button Sample 0009")
    ...
    mic_button = tk.Button(entry_row, text="🎤", command=on_mic_button_click)
